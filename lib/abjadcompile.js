...
//  },
  ...
  attachMiddleware () {
    ...
    // kernel.lilycompile = this.lilycompile
    this.middlewareAttached = true;
    atom.notifications.addSuccess("Successfully added kernel middleware!");
  ...
  consumeCompile(lilycompile) {
    this.lilycompile = lilycompile //lilycompile is available to ... const abjadCompilePlugin? How does "this" work?
